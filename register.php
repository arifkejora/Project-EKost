        ...
        <div class="container">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navigation">
                    ...
                    <a class="navbar-brand" href="index.php"><img class="logo" src="assets/img/logo2.png" alt=""></a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="page-head-content">
                    <h1 class="page-title">Buat Akun Anda Disini</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6">
                    <div class="box-for overflow">
                        <div class="col-md-12 col-xs-12 register-blocks">
                            ...
                            <form action="add_accountkost.php" method="post">
                ...
                <div class="col-md-6">
                    <div class="box-for overflow">
                        <div class="col-md-12 col-xs-12 login-blocks">
                            <h2>Masuk : </h2>
                            <form action="add_loginaccount.php" method="post">
                                <div class="form-group">
                                    <label for="email">Email</label>
